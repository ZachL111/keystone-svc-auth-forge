...
`keystone-svc-auth-forge` is centered on backend services work in Kotlin. The technical target is: Design a Kotlin verification harness for auth systems, covering security rule linting, safe and unsafe fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 172. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 6.
