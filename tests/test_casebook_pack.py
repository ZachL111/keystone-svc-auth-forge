"""Regression checks for the keystone-svc-auth-forge casebook."""
...
from casebook.harness import assert_expected, keystone_svc_auth_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_svc_auth_forge_summary(), assert_expected())
